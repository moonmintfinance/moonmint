#Chad Mint Finance - Commercial License Agreement

**IMPORTANT**: By downloading, installing, or operatingChad Mint in a production environment, you agree to be bound by these terms. If you do not agree, you must use only the non-production features under the Business Source License.
...
- **Payment Schedule**: 
  ...
  - Send 10% in a single daily payment to the
    wallet addressChad Mint provides you with on receipt of your licence
  - Minimum daily payment: 0.01 SOL (smaller amounts accumulate)

**Verification:**
- You agree to provide wallet addresses used to collect fees
-Chad Mint may request on-chain verification via blockchain explorer
...
### What's Included
- Production use ofChad Mint token minter repository
...
1. **No Brand Confusion**
   ...
   - You will not imply affiliation withChad Mint Finance
...
3. **No Resale or Sublicensing**
   - You cannot resell, redistribute, or sublicenseChad Mint
...
- All users may useChad Mint freely under MIT terms
---
...
- You are usingChad Mint only in the production deployment(s) specified at purchase
- You will not useChad Mint in any production environment without this agreement
...
-Chad Mint Finance retains all rights toChad Mint and its trademarks and the source code of this repository
- You may not claim ownership or authorship ofChad Mint
...
Moon Mint Finance is not liable for any damages, including data loss, business interruption, or lost profits arising from use of theChad Mint token minter.

---

## Limitation of Liability

Except for your payment obligations,Chad Mint Finance's total liability under this agreement shall not exceed the amount paid for this license. This limitation applies to all causes of action and theories of liability.
...
After receiving your request,Chad Mint Finance will provide:
1. A formal Commercial License Agreement to sign
2. A wallet address to whichChad Mint will receive its 10% fee
...
- The comment must use this exact format "//License key "your key", issued byChad Mint Finance, expiring "date"
...
-Chad Mint Finance may verify license keys via automated scanning
- Violations discovered via scanning will result in immediate suspension notice

**License Key Verification:**
-Chad Mint Finance may request proof of license key installation at any time
...
Upon termination:
- You must cease production use ofChad Mint

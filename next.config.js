...
const nextConfig = {
  ...
  headers: async () => {
    ...
    const devScriptSrc = "script-src 'self' 'unsafe-inline' 'unsafe-eval' 'wasm-unsafe-eval' https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://va.vercel-scripts.com";

    // Production CSP - no unsafe-eval, much stricter
    // FIXED: Added https://va.vercel-scripts.com for Vercel Analytics
    const prodScriptSrc = "script-src 'self' 'unsafe-inline' 'wasm-unsafe-eval' https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://va.vercel-scripts.com";
    ...
    const cspValue = [
      ...
      // Connect sources - Solana RPC endpoints + Pump.fun API
